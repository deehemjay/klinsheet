      ...
      <div className="aboutbody2">
        <div className="aboutleftyside">
          ...
          <p>
            ...
            over 6 years in all kinds of background check services, we are
            confident that we will help you to get the right candidates at all
            times.We leverage automated processes in all our projects, and we
            have the internal capabilities to deliver innovative IT
            interventions for HR problems. Becoming your services provider, we
